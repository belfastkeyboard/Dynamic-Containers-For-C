...
#define constructor_array(type) {                                                                                     \
    ._elements = 0, ._capacity = 0, ._elem_size = sizeof(type), ._array = calloc(0, sizeof(int)),                     \
...
{                                                                          \
    ...
    {                                                                      \
        ...
        type *cpy = calloc(_capacity, arr->_elem_size);                    \
...
{                                                                          \
    ...
    type *cpy = calloc(arr->_elements, arr->_elem_size);                   \
    memcpy(cpy, arr->_array, arr->_elem_size * arr->_elements);            \
    free(arr->_array);                                                     \
    arr->_array = calloc(amount, arr->_elem_size);                         \
...
{                                                                          \
    ...
    memcpy(cpy, arr->_array, arr->_elem_size * arr->_elements);            \
    free(arr->_array);                                                     \
    arr->_array = calloc(arr->_elements, arr->_elem_size);                 \
    memcpy(arr->_array, cpy, arr->_elem_size * arr->_elements);            \
    free(cpy);                                                             \
